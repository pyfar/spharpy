...
def test_spherical_harmonic(make_coordinates):
    Nmax = 1
...
def test_spherical_harmonic_n10(make_coordinates):
    Nmax = 10
    theta = np.array([np.pi/2, np.pi/2, 0], dtype=float)
    phi = np.array([0, np.pi/2, 0], dtype=float)

    coords = make_coordinates.create_coordinates(
        np.ones_like(theta), theta, phi)
...
def test_spherical_harmonics_real(make_coordinates):
    n_max = 10
...
def test_orthogonality(make_coordinates):
    """
...
def test_orthogonality_real(make_coordinates):
    """
...
def test_spherical_harmonic_basis_gradient(make_coordinates):
    n_max = 15
