...
import spharpy.samplings._eqsp.partitions as eq


def test_caps_dim_2():
    reference_cap = np.array([0.643501108793284, 1.570796326794896,
...
def test_caps_dim_1():
    reference_cap = np.array([0.628318530717959,
                              1.256637061435917,
                              1.884955592153876,
                              2.513274122871834,
                              3.141592653589793,
...
def test_ideal_region_list():
    ...
    n_collars = 2
    r_regions = eq.ideal_region_list(dim, N, c_polar, n_collars)
    reference = np.array([1.000000000000000,
                          3.999999999999999,
                          4.000000000000001,
                          1.000000000000000])
    npt.assert_almost_equal(r_regions, reference)
...
def test_cap_colats():
    ...
    reference = np.array([0.643501108793284,
                          1.570796326794896,
                          2.498091544796509,
                          3.141592653589793])
