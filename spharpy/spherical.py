...
class SphericalHarmonics:
    ...
    - θ is the colatitude (angle from the positive z-axis)
    - φ is the azimuth (angle from the positive x-axis in the xy-plane)

    The normalization term Nnm is given by:

    .. math::
        N_{nm} = \sqrt{\frac{(2n+1)(n-m)!}{4π(n+m)!}}
    ...
    .. math::
        ∫_{sphere} Y_{nm} Y_{n'm'}* dω = δ_{nn'} δ_{mm'}
    ...
    def __init__(self, n_max, coords, basis_type='complex', channel_convention='acn', inv_transform_type=None,
                 normalization='n3d', weights = None):
        r"""
        ...
        """
        self.sampling_sphere = spharpy.SamplingSphere.from_coordinates(coords, n_max, weights)
