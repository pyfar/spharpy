...
[![Documentation Status](https://readthedocs.org/projects/spharpy/badge/?version=stable)](https://spharpy.readthedocs.io/en/stable/?badge=stable)
...
On Linux, you need to install libsndfile using your distributions package manager, for example ``sudo apt-get install libsndfile1``.
If the installation fails, please check out the [help section](https://pyfar-gallery.readthedocs.io/en/latest/help).

## Contributing

Check out the [contributing guidelines](https://spharpy.readthedocs.io/en/stable/contributing.html) if you want to become part of pyfar.
